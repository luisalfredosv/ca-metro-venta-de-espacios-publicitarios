...
<!--       <div class="card-header card-header-primary">
        Featured  
            ...
            <div class="card-body">
            <h2 class="card-title">Listado de Anunciantes</h2>
           <!--  <p class="card-text">FICHA TECNICA EMPRESA ANUNCIANTE Y/O AGENCIA PUBLICITARIA.</p> -->
...
<div class="col-md-12"> 
  ...
  <script defer src="js/bootstrap.min.js" crossorigin="anonymous"></script>
    ...
    <script defer src="script/datatable_lis_anun.js"></script>  
