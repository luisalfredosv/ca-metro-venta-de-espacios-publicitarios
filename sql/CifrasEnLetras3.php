<?php
/*
  CifrasEnLetra.php — ProInf.net — nov-2009, ago-2011

  CifrasEnLetra sirve para expresar una serie de cifras en letras.
  A modo de ejemplo convierte "22"> en "veintidós".
  Puede convertir un número entre una y ciento veintiséis cifras como máximo.

  Ejemplos de uso:
    CifrasEnLetra::convertirEurosEnLetras(22.34) --> "veintidós euros con treinta y cuatro céntimos"
    CifrasEnLetra::convertirNumeroEnLetras("35,67") --> "treinta y cinco con sesenta y siete"
...
class CifrasEnLetra {
  ...
  */
  protected static function convertirUnidades($unidades, $genero='neutro') {
    if ($unidades == 1) {
      if ($genero == 'masculino') return 'un';
      elseif ($genero == 'femenino') return 'un';
    }
    else if ($unidades == 21) {
  ...
  */
  public static function convertirCifrasEnLetra($cifras, $genero='neutro', $separadorGruposSeisCifras=null) {
  ...
  public static function convertirCifrasEnLetraMasculinas($cifras) {
    return self::convertirCifrasEnLetra($cifras, "masculino");
  }

  public static function convertirCifrasEnLetraFemeninas($cifras) {
    return self::convertirCifrasEnLetra($cifras, "femenino");
  }
  ...
  */
  ...
  /*
    ...
    Ejemplos:
      CifrasEnLetra::convertirEurosEnLetras("44276598801,2",2) --> "cuatrocientos noventa y ocho mil un euros con veinte céntimos"
      CifrasEnLetra::convertirEurosEnLetras(85009) --> "ochenta y cinco mil nueve euros"
      CifrasEnLetra::convertirEurosEnLetras(10200.35) --> "diez mil doscientos euros con treinta y cinco céntimos"
  */
  ...
  /*
    ...
    Ejemplos: CifrasEnLetra::formatearCifras("-4739249,2") --> "-4_739.249,2"
   */
  ...
  */
  private static function procesarEnLetras($cifras, $palabraSingular, $palabraPlural, $esFemenina) {
    ...
    // Letras
    $letras = self::convertirCifrasEnLetra($cifras, $genero);
 ...
 //   $monto = (CifrasEnLetra::convertirNumeroEnLetras($subtotal)." bolívares");
